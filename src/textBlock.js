...
function TextBlock() {
    return (
        <div id="textblock">
            ...
            <footer id='textblock-footer'>Demo Created With 🧡 By&nbsp;<a id="textblock-devsense" href="https://github.com/BEGDAR8ZOUHAIR/React-Parallax-Animation">BEGDAR8ZOUHAIR</a></footer>
        </div>
    );
}
